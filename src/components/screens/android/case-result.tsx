...
// accuracy-low merged into not-earned (option B = simplified copy, no score bar)

interface CaseResultProps {
  onNavigate: (screen: string) => void;
  variant?: "earned" | "not-earned" | "calibration";
  ...
  return (
    <div className="flex flex-col h-full" style={{ fontFamily: "'Roboto', system-ui, sans-serif", background: "var(--md-background)" }}>
      ...
      <div className="px-4 pb-3 shrink-0">
        ...
        <div className="h-1 rounded-full overflow-hidden" style={{ background: "var(--md-surface-variant)" }}>
          <div
            className="h-full rounded-full"
            style={{ width: "80%", background: "var(--md-on-surface-variant)" }}
          />
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 pb-6">
        ...
        {/* Tips to improve (Option A, not earned active only) */}
        {isNotEarned && !isWarmup && !isThreshold && !isCalibration && !isOptionB && (
          <div
        ...
        {!isWarmup && !isThreshold && !isCalibration && (
          <>
